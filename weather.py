...
class CurrentConditionsDisplay(Observer):
    ...
    def display(self):
        print("Current Current conditions:", self.temperature, 
...
class StatisticsDisplay(Observer):
    # the statistics display class is a bit different from the 
    # other observers. It doesn't need to be registered with the
    # subject, because it doesn't need to be notified of changes.
    # Instead, it just needs to keep track of the data it's
    # been given.
...
# The WeatherStation class is the main class of the program.
# It creates the WeatherData object and the observers.
